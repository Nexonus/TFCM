...
public class TFCMLampBlockEntity extends TickCounterBlockEntity implements FluidTankCallback
{
    protected FluidTank tank;

    private final LazyOptional<IFluidHandler> holder = LazyOptional.of(() -> tank);

    public TFCMLampBlockEntity(BlockPos pos, BlockState state)
    {
        super(TFCMBlockEntities.LAMP.get(), pos, state);
